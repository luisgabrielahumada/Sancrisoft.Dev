...
namespace Bussiness.Api.Controllers
{
    ...
    [AuthorizeUser]
    public class ProvidersController : WebApiController
    {
        private readonly IProvider _process;
        public ProvidersController(IProvider process)
        {
            _process = process;
        }
        [HttpGet]
        ...
        public HttpResponseMessage Post([FromBody]Provider  row)
        {
        ...
        [HttpPut]
        // PUT: api/Users/5
        public HttpResponseMessage Put(Guid id, [FromBody]Provider row)
        {
