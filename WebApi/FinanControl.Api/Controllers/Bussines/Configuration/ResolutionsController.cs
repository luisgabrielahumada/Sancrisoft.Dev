...
namespace Bussiness.Api.Controllers
{
    ...
    [AuthorizeUser]
    public class ResolutionsController : WebApiController
    {
        private readonly IResolution _process;
        public ResolutionsController(IResolution process)
        {
            _process = process;
        }
        [HttpGet]
        ...
        public HttpResponseMessage Post([FromBody]Resolution row)
        {
        ...
        [HttpPut]
        // PUT: api/Users/5
        public HttpResponseMessage Put(Guid id, [FromBody]Resolution row)
        {
